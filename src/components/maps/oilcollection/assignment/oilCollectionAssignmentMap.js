...
const allOilCollectionStates = gql`
query Unassigned {
...
class OilCollectionAssignmentMap extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.unassignedLocations) {
      const newMarkers = nextProps.unassignedLocations.map(location => {
...
export default withApollo(
  graphql(allOilCollectionStates, {name: 'Unassigned'})(OilCollectionAssignmentMap)
)