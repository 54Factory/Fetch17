...
const WDCustomerCardWrapper = styled.div`
  width: 100%;
  ...
  .isoCustomerInfoWrapper {
    width: 100%;
    display: flex;
    flex-direction: column;

    .isoCustomerCardInfos {
      width: 100%;
      display: flex;
      flex-shrink: 0;
...
const CustomerCardWrapper = WithDirection(WDCustomerCardWrapper);

export { CustomerCardWrapper };
