...
const WDCustomerFormWrapper = styled.div`
  width: 100%;
  ...
  .CustomerFormInfoWrapper {
    width: 100%;
    display: flex;
    flex-direction: column;

    .CustomerFormCardInfos {
      width: 100%;
      display: flex;
      flex-shrink: 0;
...
const CustomerFormCardWrapper = WithDirection(WDCustomerFormWrapper);

export { CustomerFormCardWrapper };
