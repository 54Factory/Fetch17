      ...
      <SidebarWrapper>
        ...
        >
          ...
          >
            ...
            >
            <Menu.Item key="createOilCustomer">
                <Link to={`${url.path}/create`}>
          ...
          <Menu.Item key="trucks">
            ...
            <Menu.Item key="users">
              ...
              <Menu.Item key="blankPage">
                <Link to={`${url.path}/adminPage`}>
                  <span className="MenuHolder" style={submenuColor}>
                    <i className="ion-document" />
                    <span className="nav-text">
                      <IntlMessages id="sidebar.adminPage" />
                    </span>
                  </span>
                </Link>
              </Menu.Item>
