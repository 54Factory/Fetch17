    ...
    return (
      <Switch>
        ...
        <Route
          ...
          component={asyncComponent(() => import("../../SetUps/completed"))}
        />
        <Route
          path={`${url}/services`}
        ...
        <Route
          ...
          component={asyncComponent(() => import("../../OilCollection/AssignTruck"))}
        />
        <Route
          exact
          path={`${url}/oilcollection/records`}
          component={asyncComponent(() => import("../../OilCollectionRecords"))}
        />
        {/* <Route
